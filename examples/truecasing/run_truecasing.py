...
""" Fine-tuning the library models for NYT truecasing (Bert or Roberta). """
...
from utils_truecasing import convert_examples_to_features, get_labels, read_examples_from_file
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help="Path to a file for storing test predictions.",
    )
    parser.add_argument(
